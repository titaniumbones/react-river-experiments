...
class StarRating extends Component {
  ...
  hoverHandler = ev => {
    ...
    Array.from(stars).forEach(star => {
      star.style.color = hoverValue >= star.dataset.value ? plusColor : defaultColor;
    });
  };
  ...
  setRating = ev => {
    ...
    Array.from(stars).forEach(star => {
      star.style.color =
        this.state.currentRating >= star.dataset.value ? plusColor : defaultColor;
    });
  };
